...
$(document).ready(function () {
    ...
    function receiveMessage(e) {
        var mensaje;
        console.log("datos de la IP:" + e.data);
        document.getElementById("videourl").value = e.data;
        ipRemote = e.data;
        if (e.origin !== "http://localhost:8080") {
            mensaje = "no se encontro la pagina padre ERROR";
        } else {
            mensaje = "Coneccion exitosa --" + e.data + " desde" + e.origin;
        }
        start();
    }
});